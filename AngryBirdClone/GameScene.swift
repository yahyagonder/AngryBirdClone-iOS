...
//  AngryBirdClone
//
//  Created by Yahya Gönder on 30.06.2022.
//
...
class GameScene: SKScene, SKPhysicsContactDelegate {
    ...
    override func didMove(to view: SKView) {
        ...
        bird2.size = CGSize(width: -self.frame.width/10, height: self.frame.height/10)
        bird2.zPosition = 1
        addChild(bird2)
        */
        ...
        bird.physicsBody?.mass = 0.17
        originalPoint = bird.position
                    ...
                    for node in touchNodes {
                        ...
                        if let sprite = node as? SKSpriteNode {
                            ...
                            if sprite == bird {
                                ...
                                let dx = -(touchLocation.x - originalPoint!.x)
                                let dy = -(touchLocation.y - originalPoint!.y)
